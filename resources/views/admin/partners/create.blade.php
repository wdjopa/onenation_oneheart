...
@section('subtitle', 'Ajoutez un partenaire ici.')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Création d'un partenaire</h4>
                <small>Tous les champs avec (*) sont obligatoires</small>
            </div>
            <div class="card-content">
                <div class="card-body">
                    <form class="form form-horizontal" method="POST" action="{{ route('partners.store') }}"
                        enctype="multipart/form-data">
                        @csrf
                        @include("admin.partners.components.form", ["fields" => $fields])
                    </form>
                </div>
            </div>
        </div>
