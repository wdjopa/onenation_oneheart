...
@section("subtitle", "Ajoutez un responsable ici.")
...
<div class="col-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Création d'un responsable</h4>
            <small>Tous les champs avec (*) sont obligatoires</small>
        </div>
        <div class="card-content">
            <div class="card-body">
                <form class="form form-horizontal" method="POST" action="{{route("responsables.store")}}"
                    enctype="multipart/form-data">
                    @csrf
                    @include("admin.responsables.components.form", ["fields" => $fields])
                </form>
            </div>
        </div>
    </div>
