                    ...
                    <div class="content">
                        <div class="infos-utiles p-5">
                            <ul>
                                ...
                                <li>{{ $orphelinat->data_address['localisation'] ?? '' }} ({{ $orphelinat->city->name }})
                                </li>
                                <li>{{ $orphelinat->data_identity_promoter['promoter_phone'] }} /
                                    {{ $orphelinat->data_identity_promoter['second_phone'] ?? '' }}</li>
                                <li>
                                ...
                                <div class="accordion" id="accordionExample">
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="heading1">
                                            <button class="accordion-button cust-accordion-btn" type="button"
        ...
        @if (str_starts_with($orphelinat->data_address['google_address'], '<iframe'))
            <div class="f-container">
                <div class="localisation-title mb-5" style="text-align: center">
                    <h1 style="color: #0313A0; text-transform: uppercase">Comment trouver
                        {{ $orphelinat->data_identity['name'] }} ?</h1>
                </div>
                <div class="pt-5">
